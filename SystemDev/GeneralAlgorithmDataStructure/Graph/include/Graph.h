...
protected:
    ...
    std::vector<std::list<std::pair<int, int>>> adjacencyList_; ///< Adjacency list storing (neighbor, weight) pairs.
    std::vector<std::pair<int, int>> minimumSpanningTree_; ///< Stores computed Minimum Spanning Tree edges.
...
public:
     ...
     * @param startVertex The vertex to begin DFS traversal from.
     */
    void DFS(int startVertex);

    /**
     * @brief Performs Breadth-First Search (BFS) traversal from a starting vertex.
     * @param startVertex The vertex to begin BFS traversal from.
     */
     ...
     * @param recStack A boolean vector marking vertices in the recursion stack.
