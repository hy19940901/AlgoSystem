...
public:
     ...
     */
    static bool KmpSearch(const std::string& text, const std::string& pattern);
     ...
     */
    static bool DfsTree(TreeNode* root, int target);
     ...
     * @return bool True if the target value is found, otherwise false.
     */
    static bool BfsTree(TreeNode* root, int target);
...
private:
     ...
     */
    static int KmpSearchImpl(const std::string& text, const std::string& pattern);
     ...
     * @return bool True if the target value is found, otherwise false.
     */
    static bool DfsTreeImpl(TreeNode* root, int target);
     ...
     * @return bool True if the target value is found, otherwise false.
     */
    static bool BfsTreeImpl(TreeNode* root, int target);
};
